(function(){
  ...
  const SK={tag:'Obed na pár kliknutí.',refresh:'🔄 OBNOVIŤ MENU',nameTitle:'Tvoje meno',namePlaceholder:'Meno a priezvisko',mealsTitle:'Tvoje obedy',mealsHint:'Môžeš objednať viac obedov. Každý obed môže mať inú polievku a menu.',add:'+ PRIDAŤ ĎALŠÍ OBED',noteTitle:'📝 Poznámka k objednávke',noteOptional:'(voliteľné)',notePlaceholder:'napr. burger bez cibule',paymentTitle:'💳 Spôsob platby',cash:'Hotovosť',transfer:'Prevod na účet',summary:'Súhrn objednávky',save:'ULOŽIŤ OBJEDNÁVKU',cancel:'ZRUŠIŤ OBJEDNÁVKU',notice:'Objednávanie je možné od 07:00 do 09:15. Objednávku môžeš v tomto čase aj upraviť alebo zrušiť.'};
